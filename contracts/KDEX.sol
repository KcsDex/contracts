...
// The KDEX
contract KDEX is ERC20, Ownable, Authorizable {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "KDEX::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "KDEX::delegateBySig: invalid nonce"
        );
        require(now <= expiry, "KDEX::delegateBySig: signature expired");
        ...
        returns (uint256)
    {
        require(
            ...
            "KDEX::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            safe32(
                block.number,
                "KDEX::_writeCheckpoint: block number exceeds 32 bits"
            );
