...
import { deployKDEX } from './shared/deploy'
...
describe('PitBreeder', () => {
  ...
  beforeEach(async function () {
    this.timeout(0)
    govToken = await deployKDEX(alice)
  ...
  describe("convert", function () {
    it("should convert KDEX/WETH", async function () {
    ...
    it("should convert KDEX/BUSD", async function () {
